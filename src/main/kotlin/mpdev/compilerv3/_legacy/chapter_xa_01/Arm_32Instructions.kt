package mpdev.compilerv3._legacy.chapter_xa_01
...
class Arm_32Instructions(outFile: String = ""): mpdev.compilerv3._legacy.chapter_xa_01.CodeModule {
    ...
    private val MAIN_EXITPOINT = "${mpdev.compilerv3._legacy.chapter_xa_01.MAIN_BLOCK}_exit_"
    ...
    private fun setGlobalVarAddresses() {
        val globalVarNamesList = globalVarsList + mpdev.compilerv3._legacy.chapter_xa_01.stringConstants.keys +
                listOf(TINSEL_MSG, NEWLINE, INT_FMT, mpdev.compilerv3._legacy.chapter_xa_01.STRING_BUFFER)
        outputCodeNl("")
        outputCodeNl(".align 2")
    ...
    private fun readStringAndConvertToInt() {
        ...
        outputCodeTabNl("ldr\tr1, ${mpdev.compilerv3._legacy.chapter_xa_01.STRING_BUFFER}${GLOBAL_VARS_ADDR_SUFFIX}")
        outputCodeTabNl("mov\tr2, #${mpdev.compilerv3._legacy.chapter_xa_01.STR_BUF_SIZE}\t\t")
        outputCodeTabNl("bl\tread")
        outputCodeTabNl("ldr\tr0, ${mpdev.compilerv3._legacy.chapter_xa_01.STRING_BUFFER}${GLOBAL_VARS_ADDR_SUFFIX}")
    ...
    override fun stringConstantsDataSpace() {
        mpdev.compilerv3._legacy.chapter_xa_01.code.outputCodeNl()
        mpdev.compilerv3._legacy.chapter_xa_01.code.outputCodeNl(".data")
        mpdev.compilerv3._legacy.chapter_xa_01.code.outputCodeTabNl(".align 2")
        mpdev.compilerv3._legacy.chapter_xa_01.code.outputCommentNl("buffer for string operations - max str length limit")
        mpdev.compilerv3._legacy.chapter_xa_01.code.outputCodeTabNl("${mpdev.compilerv3._legacy.chapter_xa_01.STRING_BUFFER}:\t.space ${mpdev.compilerv3._legacy.chapter_xa_01.STR_BUF_SIZE}")
    }
