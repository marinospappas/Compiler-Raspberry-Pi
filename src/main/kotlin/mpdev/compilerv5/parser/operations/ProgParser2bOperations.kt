...
import mpdev.compilerv3.parser.expressions.parseFactor
import mpdev.compilerv3.parser.expressions.parseTerm
...
fun add(typeT1: DataType) {
    ...
    when (typeT1) {
        ...
        DataType.string -> mpdev.compilerv5.parser.operations.addString()
        else -> {}
    }
}
